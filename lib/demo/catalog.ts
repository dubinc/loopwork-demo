...
export const PARTNERS: DemoPartner[] = [
  ...
  {
    name: "Avery Quinn",
    email: "avery@loopwork.link",
    username: "avery",
    tenantId: "lw_avery",
  },
  {
    name: "Caleb Wright",
    email: "caleb@loopwork.link",
    username: "caleb",
    tenantId: "lw_caleb",
  },
  {
    name: "Ines Moreau",
    email: "ines@loopwork.link",
    username: "ines",
    tenantId: "lw_ines",
  },
  {
    name: "Ravi Kapoor",
    email: "ravi@loopwork.link",
    username: "ravi",
    tenantId: "lw_ravi",
  },
  {
    name: "Yuki Tanaka",
    email: "yuki@loopwork.link",
    username: "yuki",
    tenantId: "lw_yuki",
  },
  {
    name: "Noor Alami",
    email: "noor@loopwork.link",
    username: "noor",
    tenantId: "lw_noor",
  },
  {
    name: "Anika Shah",
    email: "anika@loopwork.link",
    username: "anika",
    tenantId: "lw_anika",
    description: "Shoreline Growth",
  },
  {
    name: "Cole Brennan",
    email: "cole@loopwork.link",
    username: "cole",
    tenantId: "lw_cole",
    description: "Northline Media",
  },
  {
    name: "Lucia Moretti",
    email: "lucia@loopwork.link",
    username: "lucia",
    tenantId: "lw_lucia",
    description: "Moretti Advisory",
  },
  {
    name: "Tomasz Nowak",
    email: "tomasz@loopwork.link",
    username: "tomasz",
    tenantId: "lw_tomasz",
    description: "Felt & Pixel",
  },
  {
    name: "Samira Okonkwo",
    email: "samira@loopwork.link",
    username: "samira",
    tenantId: "lw_samira",
    description: "Okonkwo Labs",
  },
  {
    name: "Ben Adeyemi",
    email: "ben@loopwork.link",
    username: "ben",
    tenantId: "lw_ben",
    description: "Circuit & Co.",
  },
];
